        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms /</span> Edit User Detail</h4>

                <div class="card mb-4 mx-auto">
                    <form action="<?= site_url('user/update/' . $user['userId']) ?>" method="post" enctype="multipart/form-data">
                        <div class="card-body">
                            <div class="row g-4 mt-1">
                                <div class="row g-4 mt-1">
                                  ...
                                  <div class="col-md-6">
                                      ...
                                      <input type="text" class="form-control" id="phoneNum" name="phoneNum" value="<?= esc($user['phoneNum']) ?>" required>
                                  </div>
                                  ...
                                  <!-- Conditionally shown admin fields -->
                                  <div class="col-md-6 admin-only d-none">
                                      <label for="position" class="form-label">Position</label>
                                      <input type="text" class="form-control" id="position" name="position" value="<?= esc($user['position'] ?? '') ?>">
                                  </div>

                                  <div class="col-md-6 admin-only d-none">
                                      <label for="staffSince" class="form-label">Staff Since</label>
                                      <input type="date" class="form-control" id="staffSince" name="staffSince" value="<?= esc($user['staffSince'] ?? '') ?>">
                                  </div>
                              </div>
                            </div>
                            <div class="mt-4 text-center">
                                <button type="submit" class="btn btn-primary px-4">Update User</button>
                                <a href="<?= site_url('userList') ?>" class="btn btn-secondary ms-2">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function toggleAdminFields() {
            ...
            adminFields.forEach(field => {
                field.classList.toggle("d-none", !isAdmin);
            });
        }
