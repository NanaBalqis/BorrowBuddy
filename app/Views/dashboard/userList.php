        ...
        <div class="layout-page">
          ...
          >
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              <!-- Search -->
              <form action="<?= site_url('userList') ?>" method="get" class="navbar-nav align-items-center">
                <div class="nav-item d-flex align-items-center" style="width: 400px;">
                  ...
                  <input
                    ...
                    placeholder="Search by ID, name, email, phone, or membership date"
                    aria-label="Search"
                  />
                </div>
              </form>
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="<?= site_url('addUserPage') ?>" class="btn btn-primary">Add User</a>
                    </div>
                    <div class="card-body">
                        <?php if (empty($users)) : ?>
                            <p>No users found.</p>
                                ...
                                <table class="table table-striped text-center">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Phone</th>
                                            <th>User Type</th>
                                            <th class="d-none d-lg-table-cell">Membership Date</th>
                                            <th>Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php foreach ($users as $user) : ?>
                                            <tr>
                                                ...
                                                <td><?= esc($user['phoneNum']) ?></td>
                                                <td>
                                                    <span class="badge bg-<?= $user['userType'] === 'admin' ? 'primary' : 'secondary' ?>">
                                                        <?= ucfirst($user['userType']) ?>
                                                    </span>
                                                </td>
                                                <td class="d-none d-lg-table-cell"><?= esc($user['membershipDate'] ?? '-') ?></td>
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="<?= site_url('edit/' . $user['userId']) ?>" class="btn btn-success btn-sm">Edit</a>
                                                        <a href="<?= site_url('user/delete/' . $user['userId']) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Delete this user?')">Delete</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
