        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <h4 class="fw-bold py-3 mb-4 text-center">Edit Rental Info</h4>

                <div class="card" style="border-radius: 20px;">
                    <form action="<?= site_url('Rental/update/' . $rental['rentalId']) ?>" method="post">
                        <div class="card-body px-4 py-4">
                            <div class="row">
                                <!-- Rental ID -->
                                <div class="form-group mb-3 col-md-6">
                                    <label class="form-label">Rental ID</label>
                                    <input type="text" class="form-control" value="<?= esc($rental['rentalId']) ?>" disabled>
                                </div>

                                <!-- User ID -->
                                <div class="form-group mb-3 col-md-6">
                                    <label class="form-label">User ID</label>
                                    <input type="text" class="form-control" value="<?= esc($rental['userId']) ?>" disabled>
                                </div>

                                <!-- Book ID -->
                                <div class="form-group mb-3 col-md-6">
                                    <label class="form-label">Book ID</label>
                                    <input type="text" class="form-control" value="<?= esc($rental['bookId']) ?>" disabled>
                                </div>

                                <!-- Rental Date -->
                                <div class="form-group mb-3 col-md-6">
                                    <label class="form-label">Rental Date</label>
                                    <input type="date" class="form-control" name="rentalDate" value="<?= esc($rental['rentalDate']) ?>" required>
                                </div>

                                <!-- Due Date -->
                                <div class="form-group mb-3 col-md-6">
                                    <label class="form-label">Due Date</label>
                                    <input type="date" class="form-control" name="dueDate" value="<?= esc($rental['dueDate']) ?>" required>
                                </div>

                                <!-- Late Fee -->
                                <div class="form-group mb-3 col-md-6">
                                    <label class="form-label">Late Fee (RM)</label>
                                    <input type="number" step="0.01" class="form-control" name="lateFee" value="<?= esc($rental['lateFee']) ?>" readonly>
                                </div>
                                ...
                                <div class="form-group mb-3 col-md-6">
                                    ...
                                    <select class="form-select" name="status" required>
                                        ...
                                        <option value="late" <?= $rental['status'] === 'late' ? 'selected' : '' ?>>Late</option>
                            ...
                            <div class="text-center mt-4">
                                ...
                                <a href="<?= site_url('rentalHistory') ?>" class="btn btn-secondary ms-2">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
