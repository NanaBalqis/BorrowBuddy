        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="<?= base_url('dashboard') ?>" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">BorrowBuddy</span>
            </a>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="<?= base_url($userData['profile_picture'] ?? '/assets/images/default-avatar.png') ?>" alt class="w-px-40 h-40 rounded-circle" />
                    </div>
                  </a>
           ...
           <!-- Content -->
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card mb-4">
                    ...
                    <form method="POST" action="<?= site_url('profile/updateProfile') ?>" enctype="multipart/form-data">
                        <div class="card-body">
                            <div class="d-flex align-items-start align-items-sm-center gap-4 mb-4">
                                <img src="<?= base_url($userData['profile_picture'] ?? '/assets/images/default-avatar.png') ?>" 
                                    alt="User Avatar" class="d-block rounded" height="100" width="100" />
                                <div class="button-wrapper">
                                    <label for="profile_picture" class="btn btn-primary me-2 mb-2" tabindex="0">
                                        <span class="d-none d-sm-block">Upload new photo</span>
                                        <i class="bx bx-upload d-block d-sm-none"></i>
                                        <input type="file" id="profile_picture" class="account-file-input" 
                                              hidden name="profile_picture" accept="image/png, image/jpeg" />
                                    </label>
                                    <p class="text-muted mb-0">Allowed JPG or PNG. Max size 800KB.</p>
                                </div>
                            </div>
                            <div class="row">
                                <!-- Shared for both admin and member -->
                                <div class="mb-3 col-md-6">
                                    <label for="userId" class="form-label">User ID</label>
                                    <input type="text" id="userId" name="userId" class="form-control" value="<?= $userData['userId'] ?>" readonly>
                                </div>

                                <div class="mb-3 col-md-6">
                                    <label for="fullName" class="form-label">Full Name</label>
                                    <input type="text" id="fullName" name="fullName" class="form-control" value="<?= $userData['fullName'] ?>">
                                </div>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" id="phoneNum" name="phoneNum" class="form-control" value="<?= $userData['phoneNum'] ?>">
                                </div>

                                <?php if ($userType === 'member'): ?>
                                    <div class="mb-3 col-md-6">
                                        <label for="membershipDate" class="form-label">Membership Date</label>
                                        <input type="text" id="membershipDate" class="form-control" value="<?= $userData['membershipDate'] ?>" readonly>
                                    </div>
                                <?php elseif ($userType === 'admin'): ?>
                                    <div class="mb-3 col-md-6">
                                        <label for="position" class="form-label">Position</label>
                                        <input type="text" id="position" name="position" class="form-control" value="<?= $userData['position'] ?>">
                                    </div>

                                    <div class="mb-3 col-md-6">
                                        <label for="staffSince" class="form-label">Date Hired</label>
                                        <input type="text" id="staffSince" name="staffSince" class="form-control" value="<?= $userData['staffSince'] ?>" readonly>
                                    </div>
                                <?php endif; ?>

                                <div class="mb-3 col-md-6">
                                    <label for="userType" class="form-label">Role</label>
                                    <input type="text" id="userType" class="form-control" value="<?= ucfirst($userData['userType']) ?>" readonly>
                                </div>
                ...
                <div class="card mb-4">
                    ...
                    <form method="POST" action="<?= site_url('profile/changePassword') ?>">
                        <div class="card-body">
                            <div class="row">
                                <div class="mb-3 col-md-6">
