                        ...
                        <div class="table-responsive">
                            <table class="table table-hover text-center">
                                ...
                                <tbody>
                                    <?php
                                    $reports = [
                                        ['Monthly Rental Summary', 'Total rentals and late fees grouped by month', 'monthly-rental'],
                                        ['Most Rented Books', 'Books with the highest rental frequency', 'most-rented'],
                                        ['Overdue Rentals Report', 'List of rentals that are overdue', 'overdue'],
                                        ['Favorite Books Ranking', 'Books most frequently added to favorites', 'favorites'],
                                        ['Return Timeliness', 'Days early or late each book was returned', 'return-timeliness'],
                                    ];
                                    $i = 1;
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= esc($r[1]) ?></td>
                                            <td>
                                                <a href="<?= site_url('reports/' . $r[2]) ?>" class="btn btn-outline-primary btn-sm">View Report</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
