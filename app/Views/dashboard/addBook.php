          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card-header d-flex align-items-center">
                    <h4 class="mb-0">Book / Add New Book</h4>
                </div>

                <div class="card mb-4">
                    <div class="card-body">
                        <form method="post" action="<?= site_url('savebook') ?>" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="number" name="publishedYear" class="form-control" min="0" required>
                                </div>
                                <div class="mb-3 col-md-6">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="file" name="book_cover" class="form-control" accept="image/png, image/jpeg, image/jpg" required>
                                </div>
