          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-header d-flex align-items-center">
                  <h4 class="mb-0">Book / Edit Book</h4>
              </div>

              <div class="card mb-4">
                  <div class="card-body">
                      <form method="post" action="<?= site_url('user/update-book/' . $book['bookId']) ?>" enctype="multipart/form-data">
                          <div class="row">
                              ...
                              <div class="mb-3 col-md-6">
                                  <label>ISBN</label>
                                  <input type="text" name="isbn" class="form-control" value="<?= esc($book['isbn']) ?>" required>
                              </div>
                              <div class="mb-3 col-md-6">
                                  <label>Genre</label>
                                  <select name="genre" class="form-control" required>
                                      <?php foreach ($genres as $genre): ?>
                                          <option value="<?= esc($genre) ?>" <?= $book['genre'] === $genre ? 'selected' : '' ?>>
                                              <?= esc($genre) ?>
                                          </option>
                                      <?php endforeach; ?>
                                  </select>
                              ...
                              <div class="mb-3 col-md-6">
                                  ...
                                  <input type="number" name="publishedYear" class="form-control" min="0" value="<?= esc($book['publishedYear']) ?>" required>
                              </div>
                              <div class="mb-3 col-md-6">
                                  <label>Shelf Location</label>
                                  <select name="shelfLocation" class="form-control" required>
                                      <option value="">Select Shelf Location</option>
                                      <?php for ($i = 1; $i <= 20; $i++): ?>
                                          <option value="R<?= $i ?>" <?= ($book['shelfLocation'] == 'R'.$i) ? 'selected' : '' ?>>R<?= $i ?></option>
                                      <?php endfor; ?>
                                  </select>
                              </div>
                              ...
                              <div class="mb-3 col-md-6">
                                  ...
                                  <input type="number" name="totalCopies" class="form-control" min="1" value="<?= esc($book['totalCopies']) ?>" required>
                              </div>
                              <div class="mb-3 col-md-6">
                                  ...
                                  <div class="d-flex align-items-start gap-3">
                                      <?php if (!empty($book['book_cover'])): ?>
                                          <div>
                                              <img src="<?= base_url($book['book_cover']) ?>" alt="Current Cover"
                                                  style="width: 100px; height: 140px; object-fit: cover; border-radius: 6px; border: 1px solid #888;">
                                          </div>
                                      <?php endif; ?>
                                      <div class="flex-grow-1">
                                          <input type="file" name="book_cover" class="form-control mt-1" accept="image/png, image/jpeg, image/jpg">
                              ...
                              <div class="mb-3 col-12">
                                  ...
                                  <textarea name="description" class="form-control" rows="5" style="min-height:180px;" required><?= esc($book['description']) ?></textarea>
                              </div>
                          </div>

                          <div class="text-center">
                              <button type="submit" class="btn btn-primary px-5">Update Book</button>
                              <a href="<?= site_url('book') ?>" class="btn btn-secondary ms-2">Cancel</a>
                          </div>
                      </form>
                  </div>
              </div>
