...
>
  ...
  <body>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="<?= base_url('dashboard') ?>" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Borrow Buddy</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active">
              <a href="<?= site_url('main') ?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">Dashboard</div>
              </a>
            </li> 
            <li class="menu-item">
              <a href="<?= site_url('book') ?>" class="menu-link">
                <i class="menu-icon tf-icons bx  bx-book"></i>
                <div data-i18n="Payment">Book</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="<?= site_url('userList') ?>" class="menu-link">
                <i class="menu-icon tf-icons bx  bx-user-check"></i>
                <div data-i18n="Payment">Member</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="<?= site_url('rentalHistory') ?>" class="menu-link">
                  <i class="menu-icon tf-icons bx  bx-history"></i>
                  <div data-i18n="Payment">Rental History</div><i></i>
                  <?php if (isset($pendingRequests) && $pendingRequests > 0): ?>
                    <span class="badge-count flex-shrink-0 badge badge-center rounded-pill bg-danger w-px-20 h-px-20"><?= $pendingRequests ?></span>
                  <?php endif; ?>
              </a>
            </li>
            <li class="menu-item">
          ...
          <div class="content-wrapper">
                    ...
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          ...
                          <p class="mb-4">
                            You have successfully logged into the system, check report here.
                          </p>
                          <a href="<?= site_url('report') ?>" class="btn btn-sm btn-outline-primary">
                            View Report
                          </a>
                        </div>
                      </div>
            ...
            <div class="row mb-4">
                <div class="col-md-2">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <div class="fs-4"><?= esc($totalBooks) ?></div>
                ...
                <div class="col-md-2">
                    <div class="card text-center">
                        <div class="card-body">
                            <i class="bx bx-book-reader" style="font-size:2rem"></i>
                            <div class="fs-4"><?= esc($booksRentedToday) ?></div>
                            <div class="fw-bold">Rented Today</div>
                        </div>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <div class="fs-4"><?= esc($activeMembers) ?></div>
                            <div class="fw-bold">Active Members</div>
                        </div>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="card text-center">
                        <div class="card-body">
                            <i class="bx bx-time-five" style="font-size:2rem;color:red"></i>
                            <div class="fs-4"><?= esc($overdueReturns) ?></div>
                            <div class="fw-bold">Overdue Returns</div>
                        </div>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <div class="fs-4"><?= esc($booksAvailable) ?></div>
                            <div class="fw-bold">Books Available</div>
                        </div>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <div class="fs-4"><?= esc($loansThisMonth) ?></div>
                            <div class="fw-bold">Rental This Month</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-4">
                <!-- Rentals Activity Chart -->
                <div class="col-lg-6 mb-4">
                    <div class="card h-100">
                        <div class="card-header">
                            <h5>Rentals Activity</h5>
                        </div>
                        <div class="card-body">
                            <canvas id="rentalsActivityChart"></canvas>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 mb-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <canvas id="bookCategoriesPie"></canvas>
                        </div>
                    </div>
                </div>
                                ...
                                <?php if (!empty($upcomingDueDates)) : ?>
                                    <?php foreach ($upcomingDueDates as $due) : ?>
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            <?= esc($due['fullName']) ?>
                                            <span class="badge bg-warning text-dark"><?= date('M d', strtotime($due['dueDate'])) ?></span>
                                        </li>
                                    <?php endforeach; ?>
                                <?php else : ?>
                                    <li class="list-group-item text-muted">No upcoming due dates</li>
                                <?php endif; ?>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="row mb-4">
                <div class="col">
                    <div class="d-flex justify-content-between">
                        <a href="<?= site_url('addbookpage') ?>" class="btn btn-primary"><i class="bx bx-plus"></i> Add New Book</a>
                        <a href="<?= site_url('addUserPage') ?>" class="btn btn-success"><i class="bx bx-user-plus"></i> Register New Member</a>
                    </div>
                </div>
            </div>

            <!-- Main Data Section: Transactions & Overdue -->
            <div class="row mb-4">
              <div class="col-lg-8">
                  <div class="card h-100">
                      <div class="card-header d-flex align-items-center justify-content-between">
                          <h5 class="card-title m-0">Rented Status</h5>
                      </div>
                      <div class="card-body" style="max-height: 450px; overflow-y: auto;">
                          <table class="table table-striped">
                              ...
                              <tbody>
                                  <?php foreach($rentedStatus as $txn): ?>
                                  <tr>
                                      <td><?= esc($txn['member_name']) ?></td>
                                      <td><?= esc($txn['book_title']) ?></td>
                                      <td><?= esc($txn['rentalDate']) ?></td>
                                      <td><?= esc($txn['dueDate']) ?></td>
                                      <td>
                                          <?php if($txn['status'] == 'late'): ?>
                                              <span class="badge bg-danger">Late</span>
                                          <?php elseif($txn['status'] == 'returned'): ?>
                ...
                <div class="col-lg-4">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <p><b><?= count($overdueReminder) ?></b> books overdue</p>
                            <ul class="list-group mb-3">
                                <?php foreach($overdueReminder as $overdue): ?>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    <?= esc($overdue['fullName']) ?>
                                    <span class="badge bg-danger"><?= esc($overdue['title']) ?></span>
                                </li>
                                <?php endforeach; ?>
                            </ul>
                            <form method="post" action="<?= base_url('dashboard/sendReminder') ?>">
                                <button type="submit" class="btn btn-danger w-100">Send Reminder</button>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <!-- Popular Books & Membership Overview -->
            <div class="row mb-4">
                <div class="col-lg-6">
                    <div class="card h-100">
                        <div class="card-header">
                ...
                <div class="col-lg-6">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <p>Total Members: <b><?= esc($totalMembers) ?></b></p>
                            <p>New This Month: <b><?= esc($newMembersMonth) ?></b></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
    // Rentals Activity Chart
    const rentalLabels = <?= json_encode(array_map(fn($m) => date('M', mktime(0, 0, 0, $m['month'], 1)), $monthlyRentalData)) ?>;
    const rentalCounts = <?= json_encode(array_column($monthlyRentalData, 'count')) ?>;

    new Chart(document.getElementById('rentalsActivityChart'), {
      type: 'bar',
      data: {
        labels: rentalLabels,
        datasets: [{
          label: 'Books Rented',
          data: rentalCounts,
          backgroundColor: '#a14efc', // neon purple
          borderRadius: 5
        }]
      },
      options: {
    ...
    // Book Categories Pie Chart
    const categoryLabels = <?= json_encode(array_column($bookCategories, 'genre')) ?>;
    const categoryCounts = <?= json_encode(array_column($bookCategories, 'total')) ?>;

    new Chart(document.getElementById('bookCategoriesPie'), {
      type: 'pie',
      data: {
        ...
        datasets: [{
          data: categoryCounts,
          backgroundColor: [
            '#bd93f9', '#ffb86c', '#ff6e6e', '#0b4e5dff', '#6272a4',
            '#f1fa8c', '#50fa7b', '#ff79c6', '#9aedfe', '#fcbad3',
            '#451c84ff', '#194972ff', '#a1ffe4', '#ffd6e0', '#d6cef7ff'
          ],
          borderColor: '#000',
          borderWidth: 1
        }]
