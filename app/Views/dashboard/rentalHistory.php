        ...
        <div class="layout-page">
          ...
          >
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
             <!-- Search -->
              <form action="<?= site_url('rentalHistory') ?>" method="get" class="navbar-nav align-items-center">
                <div class="nav-item d-flex align-items-center" style="width: 400px;">
                  ...
                  <input
                    ...
                    placeholder="Search by status, user ID, book ID, name, rental date..."
                    aria-label="Search"
                  />
                </div>
              </form>
                                ...
                                <table class="table table-striped text-center">
                                    ...
                                    <tbody>
                                        <?php foreach ($rentals as $rental) : ?>
                                            <tr>
                                                <td><?= esc($rental['rentalId']) ?></td>
                                                <td><?= esc($rental['userId']) ?></td>
                                                <td><?= esc($rental['fullName']) ?></td>
                                                <td><?= esc($rental['bookId']) ?></td>
                                                <td><?= esc($rental['rentalDate']) ?></td>
                                                <td><?= esc($rental['dueDate']) ?></td>
                                                <td><?= esc($rental['returnDate']) ?: '-' ?></td>
                                                <td><?= $rental['lateFee'] ? 'RM' . esc($rental['lateFee']) : '-' ?></td>
                                                <td><?= esc($rental['status']) ?></td>
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="<?= site_url('Rental/edit/' . $rental['rentalId']) ?>" class="btn btn-success btn-sm text-white">Edit</a>
                                                        <a href="<?= site_url('Rental/delete/' . $rental['rentalId']) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Delete this record?')">Delete</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
