        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms /</span> Add New User</h4>
                      ...
                      <div class="card-body">
                          <div class="row g-4 mt-1">
                              ...
                              <div class="col-md-6">
                                  ...
                                  <input type="text" class="form-control" id="phoneNum" name="phoneNum" placeholder="Enter phone number" required>
                              </div>
                              ...
                              <div class="col-md-6 admin-only d-none">
                                  ...
                                  <input type="date" class="form-control" id="staffSince" name="staffSince">
                              </div>
                          </div>
